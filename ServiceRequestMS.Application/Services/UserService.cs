...
namespace ServiceRequestMS.Application.Services
{
    public class UserService : IUserService
    {
        ...
        public async Task<ApiResponse<IEnumerable<UserDto>>> GetPagedUsers(int pageNumber, int pageSize, string? sortBy = null, string sortOrder = "desc")
        {
            if (pageNumber < 1)
            {
                pageNumber = 1;
            ...
            var users = await _unitOfWork.Users.GetPagedUsers(pageNumber, pageSize, sortBy, sortOrder);
